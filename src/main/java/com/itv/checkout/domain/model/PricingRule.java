...
public interface PricingRule {
     ...
     * @return Pricing containing the summed price for the number of eligible units covered by this rule, and the number of units covered by this rule of those requested
     */
